...
describe('test/service/author.test.js', () => {
  ...
  it('should save authorInfo in batch', function* () {
    ...
    let authorsDetailInfo = [{
      ...
      anecdote: [{"anecdoteTitle":"人品辩诬","anecdoteUrl":"http://so.gushiwen.org/ziliao_431.aspx"},{"anecdoteTitle":"生活","anecdoteUrl":"http://so.gushiwen.org/ziliao_429.aspx"},{"anecdoteTitle":"传闻轶事","anecdoteUrl":"http://so.gushiwen.org/ziliao_430.aspx"},{"anecdoteTitle":"诗文成就","anecdoteUrl":"http://so.gushiwen.org/ziliao_432.aspx"},{"anecdoteTitle":"生平","anecdoteUrl":"http://so.gushiwen.org/ziliao_428.aspx"},{"anecdoteTitle":"骈体文","anecdoteUrl":"http://so.gushiwen.org/ziliao_433.aspx"}]
    }];
    console.log( 'authorService', authorsDetailInfo );
    // assert( typeof authorService === 'object' );
...
rl":"http://so.gushiwen.org/ziliao_431.aspx"},{"anecdoteTitle":"生活","anecdoteUrl":"http://so.gushiwen.org/ziliao_429.aspx"},{"anecdote
Title":"传闻轶事","anecdoteUrl":"http://so.gushiwen.org/ziliao_430.aspx"},{"anecdoteTitle":"诗文成就","anecdoteUrl":"http://so.gushiwen.
org/ziliao_432.aspx"},{"anecdoteTitle":"生平","anecdoteUrl":"http://so.gushiwen.org/ziliao_428.aspx"},{"anecdoteTitle":"骈体文","anecdot
